...
public class SistemaEscolar {
    ...
    public void listarTurmas(){
        ...
        for(int i =0; i < e1.getQtdeTurmas(); i++){
            /*System.out.println("Número: " + e1.getTurma(i).getNroTurma() +
                " - Curso: " + e1.getTurma(i).getNomeCurso() + 
                "- Ano: " + e1.getTurma(i).getAnoIngresso() + 
                " - Qtde alunos: " + e1.getTurma(i).getQtdeAlunos());*/
            //ou
            ...
            if(t.getNroTurma() == numTurma){
                ...
                while (t.getAluno(posAluno) != null){
                    String linha = "Nome: " + t.getAluno(posAluno).getNome()
                        + " - Matrícula: " + t.getAluno(posAluno).getMatricula()
